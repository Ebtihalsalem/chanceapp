...
class AddCv3 extends StatefulWidget {
  final String title;
  final String name;

  const AddCv3({super.key, required this.title, required this.name});

  @override
  State<AddCv3> createState() => _AddCvState();
}
...
class _AddCvState extends State<AddCv3> {
